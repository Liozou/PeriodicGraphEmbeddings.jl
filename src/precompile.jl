...
precompile(Tuple{typeof(Base.deepcopy_internal),Vector{CrystalNets.EquivalentPosition{T}},IdDict{Any, Any}})
precompile(Tuple{typeof(CrystalNets.find_refid), Vector{String}})
precompile(Tuple{typeof(parse), Type{CrystalNets.EquivalentPosition{T}}, String, NTuple{3,String}})
precompile(Tuple{typeof(CrystalNets.rationaltostring), Int, Bool, Bool})
precompile(Tuple{typeof(show), Base.TTY, CrystalNets.EquivalentPosition{T}})
precompile(Tuple{typeof(show), Base.IOStream, CrystalNets.EquivalentPosition{T}})
precompile(Tuple{Type{cell}, Int, mat, Vector{CrystalNets.EquivalentPosition{Rational{Int}}}})
precompile(Tuple{Type{cell}, Int, Matrix{BigFloat}, Vector{CrystalNets.EquivalentPosition{Rational{Int}}}})
precompile(Tuple{typeof(==), cell, cell})
precompile(Tuple{Type{cell}, Int, NTuple{3,BigFloat}, NTuple{3,BigFloat}, Vector{CrystalNets.EquivalentPosition{Rational{Int}}}})
precompile(Tuple{Type{cell}, Int, NTuple{3,Int}, NTuple{3,Int}, Vector{CrystalNets.EquivalentPosition{Rational{Int}}}})
...
precompile(Tuple{typeof(CrystalNets.periodic_distance!), MVector{3,Float64}, fmat, Bool, Float64})
